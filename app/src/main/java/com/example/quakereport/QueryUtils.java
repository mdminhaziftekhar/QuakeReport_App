...
public class QueryUtils {
    ...
    private static String makeHttpRequest(URL url) throws IOException{
        ...
        try {
            ...
            if(urlConnection.getResponseCode() == 200){
                ...
                Log.e(EarthquakeActivity.LOG_TAG, "Problem retrieving the earthquake JSON response", e);
        } finally {
    ...
    public static List<EarthquakeDataClass> extractFeatureFromJson(String earthquakeJSON){
        ...
        List<EarthquakeDataClass> earthquakes = new ArrayList<EarthquakeDataClass>();
        ...
        try {
            ...
            for(int i = 0; i<earthquakeArray.length(); i++){
                ...
                EarthquakeDataClass earthquake = new EarthquakeDataClass(magnitude, location, time, url);
     ...
     */
    public static List<EarthquakeDataClass> fetchEarthquakeData(String requestUrl){
        //to check and simulate slow response from the web
        /*
        try {
            Thread.sleep(2000);
        ...
        */
        ...
        List<EarthquakeDataClass> earthquakes = extractFeatureFromJson(jsonResponse);
